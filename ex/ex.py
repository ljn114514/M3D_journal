...
img_dir = 'dataset/Mars/bbox_test/'
test_dataset = dataset.videodataset(dataset_dir=img_dir, txt_path='list_test_seq.txt', new_height=256, new_width=128, 
...
pretrained = '../weight/resnet50_3d_mars_500.pth'
